...
const nodeDataArray = [
    ...
    { "key": 3, "pos": "-70 90", "icon": "gasprocessing", "color": "blue", "text": "Gas Processing" },
    { "key": 4, "pos": "40 -50", "icon": "fractionation", "color": "blue", "text": "Gas Fractionation" },
    { "key": 5, "pos": "140 -50", "icon": "pyrolysis", "color": "orange", "text": "Pyrolysis (Cracking)" },
    { "key": 6, "pos": "340 -130", "icon": "polymerization", "color": "red", "text": "Basic Polymers" },
    { "key": 7, "pos": "340 -40", "icon": "polymerization", "color": "green", "text": "Plastics" },
    { "key": 8, "pos": "340 50", "icon": "polymerization", "color": "lightgreen", "text": "Synthetic Rubbers" },
    { "key": 9, "pos": "340 120", "color": "orange", "text": "Intermediates" },
    { "key": 10, "pos": "340 210", "icon": "finishedgas", "color": "blue", "text": "LPG, Naphtha,\nMTBE" },
    { "key": 11, "pos": "340 300", "icon": "finishedgas", "color": "blue", "text": "Natural Gas, NGLs", "picture": "https://cdn.pixabay.com/photo/2015/04/23/22/00/tree-736885_1280.jpg" }
];
const linkDataArray = [
...
function generateUniqueKey() {
    const maxKey = Math.max(...nodeDataArray.map(node => node.key));
    return maxKey + 1;
}
...
const createDiagram = () => {
    ...
    // document.getElementById("agregarNodoButton").addEventListener("click", () => {
    //     // Genera un nuevo ID único para el nodo
    //     const newKey = generateUniqueKey();

    //     // Crea un nuevo nodo y agrégalo al arreglo nodeDataArray
    //     const newNodeData = {
    //         key: newKey,
    //         pos: "-200 -200",  // Especifica la posición deseada para el nuevo nodo
    //         //icon: "natgas", // Puedes especificar el icono que desees
    //         color: "blue",
    //         text: "Nuevo Nodo",
    //         picture: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRDRbZbkhT3GNPpYYrzDk36V-dhPcmB6MdccFbx9wDhig&s"
    //     };

    //     nodeDataArray.push(newNodeData);

    //     // Actualiza el modelo del diagrama con el nuevo arreglo nodeDataArray
    ...
    function loop() {
        diagram.links.each(link => {
            ...
            var off = shape.strokeDashOffset - 0.5;
